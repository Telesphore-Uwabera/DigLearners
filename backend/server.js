...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log('  Teachers/Admins: use teacher login (email/password). Admins access elevated features in Teacher dashboard.')
      console.log('  Students: login with name, grade, and registration code (generated by a teacher).')
      console.log('═══════════════════════════════════════════════════════')
    })
  } catch (error) {
